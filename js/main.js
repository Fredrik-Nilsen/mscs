...
document.addEventListener("DOMContentLoaded", function() {
    const questions = [
       "Jeg utsetter kjedelige oppgaver i tjenesten eller studiene til siste liten",
        "Når jeg får et oppdrag eller en rutineoppgave (f.eks. puss og vedlikehold), løser jeg det før jeg gjør mer lystbetonte ting",
        "Jeg utsetter forberedelser (f.eks. pakking, studier) så lenge at det går ut over min og lagets stridsevne/effektivitet",
        "Jeg disponerer tiden min effektivt når vi har forberedelsesfase eller selvstudium",
        "Jeg har vanskelig for å komme i gang med rutinearbeid og tunge oppgaver i felt eller på studiehverdagen",
        ...
        "Jeg lar meg lett styre av umiddelbare behov (f.eks. hvile, varme, mat) i stedet for å gjøre det oppdraget krever der og da",
        ...
        "Jeg handler ofte overilt under press, uten å vurdere konsekvensene eller andre handlingsalternativer",
        ...
        "Jeg er strukturert i min forberedelse og vet nøyaktig hva som må gjøres, når og av hvem",
        ...
        "I risikofylte eller skremmende situasjoner (f.eks. stridsdrill, krevende øvelser) bruker jeg mentale teknikker for å kontrollere frykten og gjennomføre",
